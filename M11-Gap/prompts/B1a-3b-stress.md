Bạn là REVIEWER ĐỘC LẬP cho batch B1a — TẤN CÔNG/FUZZ. **CẤM SỬA FILE TRONG REPO** (nháp trong /tmp thì được).
...
Chấm các mục **F1..F8** — viết script nháp trong /tmp rồi chạy, dán số đo thật.
