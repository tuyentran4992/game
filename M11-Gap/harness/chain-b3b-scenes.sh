...
echo "[$(date -u '+%F %T')] HOÀN TẤT 4 scene B3b (Shop/Score/End/Album)…" >> "$LOG"
python3 harness/claude_step.py --batch B3b --step 2b-fix-scenes --prompt B3b-2b-fix-scenes.md --max-turns 110 >> "$LOG" 2>&1
